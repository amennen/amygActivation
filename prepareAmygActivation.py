...
# do this in a different way - have it in config so that no absolute paths are added!
...
def buildSubjectFoldersCluster(cfg):
    ...
    simulating what you would have to do if you were running it all on another computer"""
...
def main():
    ...
    # this is the IP address if you processing data on a cloud server
